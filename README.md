...
- **Лимиты AI**: гостю 2 пробных запроса в сутки, дальше регистрация;
  авторизованному — 30 в сутки. Считается по хешу IP / id пользователя,
  чтобы открытый эндпоинт нельзя было использовать для слива бюджета API.
